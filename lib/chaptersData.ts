    ...
    questions: [
      {
        ...
        acceptableAnswers: [
          ...
          "No, it doesn't have a complete thought.",
      ...
      },
      {
        ...
        acceptableAnswers: [
          "The skunk is collecting food.",
          "The answer is is.",
          "The answer is 'is'.",
          "You should put is.",
          "It should be is.",
          "The missing verb is is.",
          "Add is to complete the sentence.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          ...
          "The skunk is collecting food. Alex is helping her gather it.",
          "The skunk is collecting food. Alex helps the skunk.",
          "The skunk is collecting food. Alex is assisting her.",
          "The skunk is collecting food. Alex is helping the skunk carry food.",
          "The skunk is collecting food. Alex is giving her a hand.",
          "The skunk is collecting food. Alex is helping her pick up food.",
        ],
      ...
      },
      {
        ...
        expectedAnswer: "I collect food.",
        acceptableAnswers: [
          "The correct sentence is I collect food.",
          "You should say I collect food, not I collects food.",
          "That is incorrect. It should be I collect food.",
          "The skunk is collecting food.",
          "The skunk collects food.",
        ],
    ...
    questions: [
      {
        ...
        acceptableAnswers: [
          "No.",
          "It is incorrect.",
          "No, the verb is wrong.",
          "No, it doesn't agree.",
          "The sentence is incorrect.",
          "No, it should be falls.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "It falls back inside.",
          "The answer is falls.",
          "It should be falls.",
          "Use falls.",
          "The correct verb is falls.",
          "Add s, falls.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "The squirrel is worried",
          "Number 2.",
          "Number 2",
          "The second sentence is correct.",
          "It should be is, not are.",
          "The squirrel is worried is correct.",
          "Use is because squirrel is singular.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          ...
          "The squirrel is worried. It carries the nut.",
          "The squirrel is worried. It holds the nut tightly.",
          "The squirrel is worried. It picks up the nut.",
          "The squirrel is worried. It brings the nut inside.",
          "The squirrel is worried. It keeps the nut safe.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "The squirrel takes the nut and it falls again",
          "The correct sentence is the squirrel takes the nut and it falls again.",
          "You should say takes and falls.",
          "The squirrel takes the nut and then it falls again.",
        ],
    ...
    questions: [
      {
        ...
        acceptableAnswers: [
          ...
          "It is incorrect.",
          "No, the verb is wrong.",
          "No, it is not in past tense.",
          "The sentence is incorrect.",
          "No, it should be flew.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex flew to the fence.",
          "The answer is flew.",
          "It should be flew.",
          "Use flew.",
          "The correct verb is flew.",
      ...
      },
      {
        ...
        acceptableAnswers: [
          ...
          "Alex flew to the fence and picked up the hat.",
          "Alex flew to the fence and took the hat.",
          "Alex flew to the fence and brought the hat back.",
          "Alex flew to the fence and grabbed the hat.",
          "Alex flew to the fence and returned with the hat.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex flew to the fence and returned the hat",
          "Alex flew to the fence and then returned the hat.",
          "It should be flew and returned.",
          "The correct sentence is Alex flew to the fence and returned the hat.",
          "Use past tense flew and returned.",
          "Alex flew to the fence and brought back the hat.",
        ],
    ...
    questions: [
      {
        ...
        acceptableAnswers: [
          "No.",
          "It is incorrect.",
          "No, the word form is wrong.",
          "No, bravefully is incorrect.",
          "The sentence is incorrect.",
          "No, it should be brave.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex is a brave bird.",
          "The answer is brave.",
          "It should be brave.",
          "Use brave.",
          "The correct word is brave.",
      ...
      },
      {
        ...
        acceptableAnswers: [
          ...
          "Alex is a brave bird. He fixes the nest.",
          "Alex is a brave bird. He helps repair the nest.",
          "Alex is a brave bird. He carries sticks for the owl.",
          "Alex is a brave bird. He builds a new nest.",
          "Alex is a brave bird. He takes care of the owl.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex is a brave bird",
          "The correct sentence is Alex is a brave bird.",
          "It should be brave, not bravefully.",
          "Alex is a very brave bird.",
          "You should say Alex is a brave bird.",
          "That is incorrect. It should be Alex is a brave bird.",
        ],
    ...
    questions: [
      {
        ...
        acceptableAnswers: [
          ...
          "He helped animals.",
          "He helped the animals.",
          "Alex helped animals in the story.",
          "He helped a lot of animals.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex helped many animals.",
          "The answer is helped.",
          "It should be helped.",
          "Use helped.",
          "The correct verb is helped.",
          "The past tense is helped.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          ...
          "Alex helped many animals and they thanked him.",
          "Alex helped many animals and they became his friends.",
          "Alex helped many animals and they were happy.",
          "Alex helped many animals and they supported him.",
          "Alex helped many animals and they helped him go home.",
        ],
      ...
      },
      {
        ...
        acceptableAnswers: [
          "Alex helped many animals and he went home",
          "The correct sentence is Alex helped many animals and he went home.",
          "It should be helped, animals, and went.",
          "Alex helped many animals, and he went home.",
          "Use past tense helped and went.",
          "Alex helped many animals and then he went home.",
        ],
