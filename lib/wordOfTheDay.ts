import type { WordOfTheDayEntry } from "@/types/wordOfTheDay";

/**
 * 60 words (~2 months of daily content), organized by difficulty.
 * Ported from PronounceRight, tailored for Filipino English learners.
 *
 * Beginner  (1–20):  Vowels, consonants, basic pronunciation
 * Intermediate (21–40): Stress, intonation, multi-syllable words
 * Advanced  (41–60):  Academic & conversational vocabulary
 */
export const WORD_OF_THE_DAY_BANK: WordOfTheDayEntry[] = [
  ...
  },
  {
    ...
    pronunciationTip:
      'Use a long /iː/ vowel — stretch the "ee" sound. Be careful with the final /tʃ/ (like "ch" in "cheese").',
    difficulty: 'beginner',
  },
  {
    id: 'very',
  ...
  },
  {
    ...
    pronunciationTip:
      'Stress the 2nd syllable: "per-TIK-yoo-ler". Keep the "TIK" syllable strong and clear.',
    difficulty: 'intermediate',
  },
  {
    id: 'experience',
  ...
  },
  {
    ...
    pronunciationTip:
      'Stress the 2nd syllable: "spuh-SIF-ik-lee". The word starts with the consonant cluster /sp/ — don\'t add "e" before it.',
    difficulty: 'advanced',
  },
  {
    id: 'conscience',
    ...
    pronunciationTip:
      'Only 2 syllables: "KON-shuns". The "sci" makes a /ʃ/ sound (like "sh"). Don\'t confuse with "conscious" (KON-shus).',
    difficulty: 'advanced',
  },
  {
    id: 'pronunciation',
  ...
  },
  {
    ...
    pronunciationTip:
      'Pronounced "KUR-nul" — it sounds nothing like it looks! The spelling comes from Italian but the pronunciation from French.',
    difficulty: 'advanced',
  },
  {
    id: 'subtle',
...
// ─── Epoch ────────────────────────────────────────────────────────────────────
// June 2, 2025 — start of Philippine SY 2025-2026
const EPOCH = new Date(2025, 5, 2);
